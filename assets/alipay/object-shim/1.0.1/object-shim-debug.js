define("alipay/object-shim/1.0.1/object-shim-debug", [ "$-debug", "./object-shim-debug.css" ], function(require, exports, module) {
    var $ = require("$-debug");
    var OBJECT_SHIM_CLASS = "object-shim-class";
    require("./object-shim-debug.css");
...
define("alipay/object-shim/1.0.1/object-shim-debug.css", [], function() {
    seajs.importStyle("body .object-shim-class{display:inline-block;*display:inline;*zoom:1;height:22px;width:198px;border:1px solid #999}body .object-shim-class object,body .object-shim-class.alieditContainer input,body .object-shim-class embed{display:none}");
});
