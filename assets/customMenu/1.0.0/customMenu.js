define("customMenu/1.0.0/customMenu", [ "$", "arale/tip/1.0.0/atip", "arale/tip/1.0.0/tip", "arale/popup/1.0.0/popup", "arale/overlay/1.0.0/overlay", "arale/position/1.0.0/position", "arale/iframe-shim/1.0.0/iframe-shim", "arale/widget/1.0.3/widget", "arale/base/1.0.1/base", "arale/class/1.0.0/class", "arale/popup/1.1.6/popup", "arale/overlay/1.1.4/overlay", "arale/position/1.0.1/position", "arale/iframe-shim/1.0.2/iframe-shim", "arale/widget/1.1.1/widget", "arale/base/1.1.1/base", "arale/class/1.1.0/class", "arale/events/1.1.0/events", "arale/widget/1.0.3/templatable", "gallery/handlebars/1.0.0/handlebars", "./customMenuTpl" ], function(require, exports, module) {
    var $ = require("$"), Atip = require("arale/tip/1.0.0/atip"), Popup = require("arale/popup/1.1.6/popup"), Templatable = require("arale/widget/1.0.3/templatable");
